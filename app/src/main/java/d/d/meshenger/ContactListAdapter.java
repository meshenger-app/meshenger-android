...
public class ContactListAdapter extends ArrayAdapter<Contact> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        ((TextView)convertView.findViewById(R.id.contact_item_address)).setText(c.getAddress());

        if(c.getState() != Contact.State.PENDING){
            Log.d(ContactListActivity.class.getSimpleName(), c.getAddress() + " online");
            ...
            Log.d(ContactListActivity.class.getSimpleName(), c.getAddress() + " offline");
        }
