            ...
            for (nif in all) {
                ...
                for (ia in nif.interfaceAddresses) {
                    ...
                    if (fullAddress.indexOf('%') > 0) {
                        ...
                        addressList.add(AddressEntry(subaddress, nif.name, addr.isMulticastAddress))
                    } else {
                        if (isIPv6(fullAddress)) {
                            fullAddress = "" + fullAddress + ""
                        }
                        addressList.add(AddressEntry(fullAddress, nif.name, addr.isMulticastAddress))
                    }
                }
            }
        } catch (ex: Exception) {
            ...
            for (nif in all) {
                ...
                for (ia in nif.interfaceAddresses) {
                    ...
                    if (addr is Inet6Address) {
                        ...
                        if (extracted_mac != null && Arrays.equals(extracted_mac, nif.hardwareAddress)) {
                            ...
                            val new_addr: InetAddress? = createEUI64Address(addr6, contact_mac_bytes)
                            if (new_addr != null) {
