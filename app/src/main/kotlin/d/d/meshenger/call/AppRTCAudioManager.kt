...
*/
class AppRTCAudioManager private constructor(val context: Context, val useSpeakerphone: String?) {
    ...
    interface AudioManagerEvents {
        ...
        fun onAudioDeviceChanged(
            selectedAudioDevice: AudioDevice, availableAudioDevices: HashSet<AudioDevice>
        )
    }
    ...
    private inner class WiredHeadsetReceiver: BroadcastReceiver() {
        ...
        override fun onReceive(context: Context?, intent: Intent) {
            ...
            Log.d(
                TAG, "WiredHeadsetReceiver.onReceive" + AppRTCUtils.getThreadInfo() + ": "
                        + "a=" + intent.action + ", s="
    ...
    */
    ...
    fun stop() {
        ...
        audioManager!!.mode = savedAudioMode //TODO: Erratic variable assigning
    ...
    fun getAudioDevices(): Set<AudioDevice?>? {
        ThreadUtils.checkIsOnMainThread()
        return Collections.unmodifiableSet(java.util.HashSet(audioDevices))
    }
    ...
    private fun hasWiredHeadset(): Boolean {
        return if (Build.VERSION.SDK_INT < Build.VERSION_CODES.M) {
            ...
            val devices = audioManager!!.getDevices(AudioManager.GET_DEVICES_INPUTS) //TODO: Erratic constant value
    ...
    fun updateAudioDeviceState() {
        ...
        newAudioDevice = if (bluetoothManager.getState() == AppRTCBluetoothManager.State.SCO_CONNECTED) {
