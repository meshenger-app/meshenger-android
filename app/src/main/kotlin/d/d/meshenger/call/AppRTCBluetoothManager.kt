 ...
 * AppRTC demo.
 */
class AppRTCBluetoothManager private constructor (val context: Context, val apprtcAudioManager: AppRTCAudioManager) {
    ...
    private var bluetoothState = AppRTCBluetoothManager.State.UNINITIALIZED
    ...
    open fun start() {
        ...
        bluetoothAdapter = bluetoothManager.adapter //This is the new way
//        bluetoothAdapter = BluetoothAdapter.getDefaultAdapter() //TODO: Deprecated method.
     ...
     */
    open fun startScoAudio(): Boolean {
        ThreadUtils.checkIsOnMainThread()
        Log.d(
    ...
    protected open fun hasPermission(context: Context?, permission: String?): Boolean {
    ...
    protected open fun logBluetoothAdapterInfo(localAdapter: BluetoothAdapter) {
        Log.d(
