...
class HudFragment: Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        view.let {
            ...
            // Create UI controls.
            encoderStatView = it.findViewById<TextView>(R.id.encoder_stat_call)
            hudViewBwe = it.findViewById<TextView>(R.id.hud_stat_bwe)
            hudViewConnection = it.findViewById<TextView>(R.id.hud_stat_connection)
            hudViewVideoSend = it.findViewById<TextView>(R.id.hud_stat_video_send)
            hudViewVideoRecv = it.findViewById<TextView>(R.id.hud_stat_video_recv)
            toggleDebugButton = it.findViewById<ImageButton>(R.id.button_toggle_debug)
    ...
    if (args != null) {
      ...
      displayHud = args.getBoolean("CallActivity.EXTRA_DISPLAY_HUD", false);
        ...
        val visibility = View.VISIBLE //displayHud ? View.VISIBLE : View.INVISIBLE;
